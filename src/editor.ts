...
import { PMIndexCardConfig } from './types';
...
@customElement('pm-index-card-editor')
export class PMIndexCardEditor extends ScopedRegistryHost(LitElement) implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;

  @state() private _config?: PMIndexCardConfig;
