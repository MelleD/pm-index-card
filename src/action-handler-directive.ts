...
customElements.define('action-handler-pm-index', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-pm-index')) {
    return body.querySelector('action-handler-pm-index') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-pm-index');
